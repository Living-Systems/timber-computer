<template>
    <section class="building-components configurator-wrapper | flow-100" v-for="component in building.constructions.data[0].attributes.components.data[0]" :key="component">
        <!-- // component heading -->
...
console.log(props.building.constructions.data.length);
</script>